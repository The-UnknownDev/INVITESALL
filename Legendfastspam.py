...
async def start_yukki():
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk(functions.channels.JoinChannelRequest(channel="@Legend_userbotsSpam"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk(functions.channels.JoinChannelRequest(channel="@Legend_userbotsSpam"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk(functions.channels.JoinChannelRequest(channel="@Legend_userbotsSpam"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk(functions.channels.JoinChannelRequest(channel="@Legend_userbotsSpam"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk(functions.channels.JoinChannelRequest(channel="@Legend_userbotsSpam"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk(functions.channels.JoinChannelRequest(channel="@Legend_userbotsSpam"))
    ...
    if tenth:
       ...
       # edk = TelegramClient(StringSession(session_name), ia, ib)
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@Legend_userbots"))
            await edk(functions.channels.JoinChannelRequest(channel="@LEGENDBOTUB"))
            await edk(functions.channels.JoinChannelRequest(channel="@Legend_userbotsSpam"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk(functions.channels.JoinChannelRequest(channel="@Legend_userbotsSpam"))
